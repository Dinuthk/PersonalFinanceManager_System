...
export const budget = <i className="fa-solid fa-money-bill-transfer"></i>
export const income = <i className="fa-solid fa-money-check-dollar"></i>
export const expenses = <i className="fa-solid fa-money-bill-trend-up"></i>
export const user = <i className="fa-solid fa-user"></i>
export const goals = <i class="fa-solid fa-circle-dot"></i>
...
export const food = <i className="fa-solid fa-cart-shopping"></i>
export const medical = <i className="fa-solid fa-briefcase-medical"></i>
export const clothes = <i className="fa-solid fa-shirt"></i>
...
export const save = <i class="fa-solid fa-circle-check"></i>
